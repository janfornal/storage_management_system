...
CREATE TABLE PRODUCTS_SOLD (
    ...
    id_product INTEGER NOT NULL REFERENCES PRODUCTS(id),
    id_product_with_problem INTEGER REFERENCES PRODUCTS_PROBLEMS(id_product_with_problem),
    CONSTRAINT ps_key UNIQUE (id_sale, id_product, id_product_with_problem),
    quantity NUMERIC(10) NOT NULL CHECK (quantity > 0)
);
